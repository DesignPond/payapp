...
class Laramill{
	...
	function __construct()
	{
		...
		if ( !$test_mode )
		{
			...
			$this->apiEndPoint = Config::get('laravel-paymill::api_endpoint'); 
		}
		else 
		{
     ...
     */
	function get_list_subscription($count = NULL, $offset = NULL, $offer = NULL,  $canceled_at = NULL, $created_at = NULL)
	{
	    $params = array(
           'count'       =>  $count,
           'offset'      =>  $offset,
